...
values
('11c86023-0a4f-49c2-b3a2-aede1ad05f63', 'Test1', current_timestamp, current_timestamp),
('e56b68b7-e02c-40f3-8c14-87e937475ef1', 'Test2', current_timestamp, current_timestamp);
...
('e56b68b7-e02c-40f3-8c14-87e937475ef1', (select id from public.books where title = 'ハッカーと画家'), false, false, false, false, current_timestamp, current_timestamp);

-- Insert memos

insert into public.memos (my_book_id, start_page, end_page, content, like_count, created_at, updated_at)
values
((select id from public.my_books where book_id = (select id from public.books where title = 'ハッカーと画家') and user_id = '11c86023-0a4f-49c2-b3a2-aede1ad05f63'), 2, 3, '日本人はものをうまく作ることに取り憑かれている米国人はとにかく仕事を終えることを考える。', 0, current_timestamp, current_timestamp),
((select id from public.my_books where book_id = (select id from public.books where title = 'ハッカーと画家') and user_id = '11c86023-0a4f-49c2-b3a2-aede1ad05f63'), 5, null, 'とにかくやる、という方法は速い。', 0, current_timestamp, current_timestamp),
((select id from public.my_books where book_id = (select id from public.books where title = 'ハッカーと画家') and user_id = 'e56b68b7-e02c-40f3-8c14-87e937475ef1'), 5, null, 'きっと将来最も成功する国は、今日「お国柄」と思われているようなものを捨てて、それぞれの事柄についてそれが最も有効に働く方法を探っていく国。\nさあ、競争だ。', 0, current_timestamp, current_timestamp);
